...
plt.title('Normalised Associated Legendre Polynomials')
plt.grid()
plt.legend()
plt.show()
...
plt.title('Normalised Associated Legendre Polynomials over sin(theta)')
plt.grid()
plt.legend()
plt.show()
...
plt.title('Derivatives of Normalised Associated Legendre Polynomials')
plt.grid()
plt.legend()
plt.show()
